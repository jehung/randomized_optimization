...
BatchBackPropagationTrainer = jp.JPackage('func').nn.backprop.BatchBackPropagationTrainer
RPROPUpdateRule = jp.JPackage('func').nn.backprop.RPROPUpdateRule


INPUT_LAYER = 109
OUTPUT_LAYER = 1
TRAINING_ITERATIONS = 2001
OUTFILE = './NN_OUTPUT/BACK_LOG.txt'
